...
<head>
    ...
    <title>Riwayat Pesanan - Paris Plastik</title>
    ...
    <div x-data="{ sidebarOpen: false }" class="flex min-h-screen">
        ...
        <aside 
            ...
            <div class="p-4">
                <nav class="space-y-2">
                    ...
                    <a href="?url=pesanan-riwayat" class="flex items-center gap-3 px-4 py-2 text-white bg-sky-600 rounded-lg shadow">
        ...
        <main class="flex-1 p-4 lg:p-8">
            <header class="flex justify-between items-center mb-8">
                <div>
                    <h1 class="text-2xl lg:text-3xl font-bold text-gray-800 dark:text-white">Riwayat Pesanan</h1>
                    <p class="text-sm text-gray-500 dark:text-gray-400">Daftar pesanan yang telah selesai atau dibatalkan.</p>
                </div>
                <div class="flex items-center gap-4">
                     <a href="?url=pesanan" class="bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-lg shadow-md transition-colors flex items-center gap-2">
                        <i class="fas fa-arrow-left"></i>
                        <span class="hidden sm:inline">Kembali ke Aktif</span>
                    </a>
                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full text-sm">
                        ...
                        <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                            <?php if (empty($orders)): ?>
                                <tr><td colspan="5" class="text-center py-8 text-gray-400 dark:text-gray-500">Belum ada riwayat pesanan.</td></tr>
                            <?php else: ?>
                                <?php foreach ($orders as $order): ?>
                                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-700 transition">
                                        ...
                                        <td class="hidden md:table-cell px-6 py-4 whitespace-nowrap text-gray-800 dark:text-gray-200 font-bold">Rp <?= number_format($order['total'], 0, ',', '.') ?></td>
