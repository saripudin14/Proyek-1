    ...
    <main class="p-8 bg-gradient-to-br from-blue-50 to-blue-100 min-h-screen">
        <div class="max-w-6xl mx-auto">
            <div class="flex justify-between items-center mb-6">
                <h1 class="text-3xl font-bold text-blue-800 animate-fade-in">Selamat Datang, <?= htmlspecialchars($user['name']) ?>!</h1>
                <a href="/proyek-1/public/?url=logout" class="bg-red-500 hover:bg-red-600 text-white px-4 py-2 rounded font-semibold shadow transition-all duration-200 flex items-center gap-2">
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
                <div class="bg-white rounded shadow p-6 flex flex-col items-center product-card animate-fade-in delay-100">
                    ...
                    <a href="/proyek-1/public/?url=produk" class="mt-3 px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded font-semibold shadow transition-all duration-200 nav-link-underline">Lihat Produk</a>
                </div>
                <div class="bg-white rounded shadow p-6 flex flex-col items-center product-card animate-fade-in delay-200">
                    ...
                    <a href="/proyek-1/public/?url=kategori" class="mt-3 px-4 py-2 bg-green-600 hover:bg-green-700 text-white rounded font-semibold shadow transition-all duration-200">Lihat Kategori</a>
                </div>
                <div class="bg-white rounded shadow p-6 flex flex-col items-center product-card animate-fade-in delay-300">
                    <div class="bg-green-100 p-3 rounded-full mb-2"><i data-feather="shopping-cart" class="w-6 h-6 text-green-600"></i></div>
                    ...
                    <a href="/proyek-1/public/?url=pesanan" class="mt-3 px-4 py-2 bg-green-600 hover:bg-green-700 text-white rounded font-semibold shadow transition-all duration-200">Lihat Pesanan</a>
                </div>
